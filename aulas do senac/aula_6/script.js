...
// no caso de o estudante ficar em recuperação, o programa deverá solicitar a digitação de mais uma nota. Se essa nota for menor que 5, o programa escreverá “Reprovado na Recuperação” e, caso contrário, “Aprovado na Recuperação”.
...
// } else if(nota >= 4 && nota < 7) {
//     console.log("ALUNO EM RECUPERAÇÃO");
//     let notaRecuperacao = 5;
//     if (notaRecuperacao >= 0 && notaRecuperacao < 5 ){
//         console.log("reprovado na recuperção");
//     }else {
//         console.log("aprovado na recuperção");
//     }
// } else if(nota >= 7 && nota <= 10) {
//     console.log("ALUNO APROVADO");
// }
